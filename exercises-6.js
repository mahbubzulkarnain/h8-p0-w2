...
let printLoping1 = true;
let printLoping2 = true;

while(iteration > 1){
    if(iteration <= maxIteration && printLoping2){
        if(printLoping1){
...
*/
console.log('\n\n2. Melakukan Looping Menggunakan For\n')
let maxIteration2 = 20;
console.log('LOOPING PERTAMA')
for(let i =1; i<= maxIteration2; i++){
    console.log(i+' - I love coding');
}
console.log('LOOPING KEDUA')
for(let i =maxIteration2; i > 0; i--){
